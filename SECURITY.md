...
**实现位置**: `ximonitor-server/src/main.rs:336-360`
...
**实现位置**: `ximonitor-server/src/main.rs:1082-1098`
...
**Token 生成**:
- 位置: `ximonitor-server/src/registry.rs:issue_node`
...
**实现位置**: `ximonitor-server/src/main.rs:397-495`
...
- **GitHub Security Advisory**: https://github.com/XiNian-dada/XiMonitor/security/advisories/new
- **Email**: (待补充)
